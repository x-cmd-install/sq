...
[![x-cmd/install — sq Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/sq.svg?lang=zh)](https://x-cmd.com/install/sq)
...
合计: **1,996,918** 行代码（覆盖前 5 种语言、共 **900** 个文件）。
...
- **Star**: 2,567 · **Fork**: 43 · **开放 issue**: 306 · **贡献者**: 15

## 累计统计

- **发布数**: 91 · **已合并 PR**: 734 · **开放 PR**: 10 · **已关闭 issue**: 241 · **开放 issue**: 65 · **提交数**: 1675

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-27 | 1 | 72 | 6 | 20 | 11 | 89 |
| last60d | 2026-07-28 | 1 | 109 | 6 | 20 | 11 | 139 |
| 90d | 2026-06-28 | 1 | 183 | 7 | 41 | 19 | 220 |
| last180d | 2026-03-30 | 7 | 425 | 10 | 131 | 52 | 853 |
| 360d | 2025-10-01 | 13 | 445 | 10 | 138 | 55 | 937 |
| last720d | 2024-10-06 | 15 | 467 | 10 | 153 | 56 | 1039 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/sq.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260926.yml` · 2026-09-26T05:27:14Z._
